...
//        predicates.add(p3);
        ...
        predicates.add(p6);
        query.where(predicates.toArray(new Predicate[]{}));
        query.multiselect(builder.function("MONTH", Integer.class, rootOrder.get("createdDate")), builder.sum(rootOrderAgency.get("totalPrice").as(Double.class)));
...
//        predicates.add(p3);
        ...
        predicates.add(p6);
        query.where(predicates.toArray(new Predicate[]{}));
        query.multiselect(builder.function("QUARTER", Integer.class, rootOrder.get("createdDate")), builder.sum(rootOrderAgency.get("totalPrice").as(Double.class)));
...
//        predicates.add(p3);
        ...
        predicates.add(p4);
        query.where(predicates.toArray(new Predicate[]{}));
        query.multiselect(builder.function("YEAR", Integer.class, rootOrder.get("createdDate")), builder.sum(rootOrderAgency.get("totalPrice").as(Double.class)));
